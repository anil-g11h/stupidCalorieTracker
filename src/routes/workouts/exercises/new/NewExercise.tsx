...
export default function NewExercise() {
  ...
  return (
    <div className="max-w-md mx-auto pt-8 pb-24 px-4 bg-background min-h-screen">
      <div className="bg-card p-6 rounded-2xl border border-border-subtle shadow-sm animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="mt-8 space-y-3">
          ...
          <button
            ...
            className="w-full py-3 text-text-muted font-medium hover:text-text-main transition-colors flex items-center justify-center gap-1"
          >
